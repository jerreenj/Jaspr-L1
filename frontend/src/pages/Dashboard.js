          ...
          <div key={validator.address} className="flex items-center justify-between p-4">
            ...
            <div className="text-right">
              <p className="font-mono text-sm text-white">
                {(validator.stake / 1_000_000_000_000).toFixed(0)}K JJ
              </p>
              <p className="font-mono text-xs text-zinc-500">
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-sm bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 p-8">
        ...
        <div className="relative z-10">
          ...
          <p className="font-manrope text-zinc-400 max-w-xl">
            High-performance L1 blockchain with AI-protected safety, hybrid DEX settlement, and <2s finality.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          subtitle={`${((networkStats?.validators?.total_stake || 0) / 1_000_000_000_000).toFixed(0)}K JJ staked`}
          icon={Users}
          color="green"
        />
        <StatCard
